...
public class BookStockTest {
    ...
    public void testCounterWithConcurrency() throws InterruptedException {
        ...
        System.out.println("now stock :"+ bookService.getBookByBookNo(9791196222702L).getStock());

        assertEquals(7, bookService.getBookByBookNo(9791196222702L).getStock());
        assertEquals(5534, bookService.getBookByBookNo(9791196222705L).getStock());
    }
}
