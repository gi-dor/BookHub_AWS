...
function recobook() {
    ...
    $("#recobook input[name=cate]").val(1);
    $("#recobook input[name=cateKeyword]").val(1);
    $("#recobook input[name=pubDate]").val(1);
    $("#recobook input[name=page]").val(1);
    $("#recobook input[name=sort]").val(1);
    $("#recobook").trigger("submit");
}
...
$("#cateKeyword a ").click(function (event) {
    ...
    $("#recobook input[name=cate]").val(1);
    $("#recobook input[name=cateKeyword]").val($(this).attr("data-cateKeyword"));
    $("#recobook input[name=page]").val(1);
    $("#recobook input[name=sort]").val(1);
    $("#recobook").trigger("submit");
});
...
$("#pubDate a ").click(function (event) {
    event.preventDefault();
    $("#recobook input[name=pubDate]").val($(this).attr("data-pubDate"));
    $("#recobook input[name=page]").val(1);
    $("#recobook input[name=sort]").val(1);
    $("#recobook").trigger("submit");
});
...
$("#sort a ").click(function (event) {
    event.preventDefault();
    $("#recobook input[name=page]").val(1);
    $("#recobook input[name=sort]").val($(this).attr("data-sort"));
    $("#recobook").trigger("submit");
});

$(".pagination a").click(function(event) {
    event.preventDefault();
    $("#recobook input[name=page]").val($(this).attr("data-page"));
    $("#recobook").trigger("submit");
})
